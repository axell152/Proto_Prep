...
export async function ensureSchema() {
  ...
  // Neon (HTTP driver) n'accepte pas plusieurs instructions SQL
  // dans une seule requête préparée. On crée donc chaque objet
  // séparément.
  ...
  await query`    CREATE INDEX IF NOT EXISTS idx_order_items_order_id
