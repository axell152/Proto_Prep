...
export async function ensureSchema() {
  ...
  // Neon serverless sends tagged-template queries as prepared statements.
  // A prepared statement cannot contain several SQL commands separated by ';',
  // so each DDL statement must be sent separately.
  await query`
